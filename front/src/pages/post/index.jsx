...
return (
    <div className={style.PostPage}>
        <div className={style.AuthorBox}>
            ...
            <div className={style.Name}>Иван Иванов
        ...
        <div className={style.CommentBox}>
            ...
            <div className={style.CardComment}>
                ...
                <div className={style.TextComment}>дня я хочу поделиться с вами своими лайфхаками касательно работы в PyCharm, ведь мы все хотим сократить вре</div>
            </div>           
        </div>
    </div>
    );
